...
var uploadTools = {
    ...
    "addFileList":function(fileList,opt){
        ...
        for(var i=0;i<fileList.length;i++){
            ...
            if(fileTypeArray=="*"||uploadTools.isInArray(fileTypeStr,fileTypeArray)){
				...
				var fileModel = uploadTools.getShowFileType(isImg,fileTypeUpcaseStr,fileList[i].name,imgUrlStr,fileListArray.length);
    ...
    "getShowFileType":function(isImg,fileType,fileName,isImgUrl,fileCodeId){
        ...
        if(isImg){
            ...
            showTypeStr ='';
            showTypeStr += "<a href='"+isImgUrl+"'>";
            showTypeStr +=fileName;
            showTypeStr +="</a>";
        }
        var modelStr="";
